...
## Installations
In order to run and contribute you must install Python 3.7. We recommend PyCharm as IDE for development. You have to edit the configuration and put the parameters as shown in the following picture: 
